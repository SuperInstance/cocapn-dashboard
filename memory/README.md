# Cocapn Dashboard — Memory

> *The ensign's duty log.*

This directory holds the dashboard agent's journal — a running record of watches, incidents, and fleet observations.

---

## Files

- [`JOURNAL.md`](./JOURNAL.md) — Chronological duty log. Each entry marks a watch: what happened, what changed, what needs attention.
